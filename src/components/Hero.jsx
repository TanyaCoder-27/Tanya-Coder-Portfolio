...
const Hero = ({ contactRef }) => {
  ...
  const openResume = () => {
    window.open('https://drive.google.com/file/d/1f4loI1usf9xABWYYxgAzuAnbbX5J6uBY/view?usp=sharing', '_blank');
  };
  ...
  return (
    <div className='bg-black text-white text-center py-16'>
      ...
      <h1 className='text-4xl font-bold'>I am <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Andra Tulasi Lakshmi Tanya</span>, passionate Computer Science student with a focus on building modern, responsive web applications and advancing automation testing.

</h1>
      <p className='mt-4 text-lg text-gray-300'>I am interested in Automation Testing,Web development and GenAI.</p>
